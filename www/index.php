...
διαδεδομένους συγχρονους browsers (Chrome, Firefox, Opera, Edge κλπ).
...
θα πρέπει να είστε άνω των 18 ετών και να έχετε διαβάσει προσεκτικά τους
<a href="#">όρους χρήσης</a> του ιστοτόπου.
