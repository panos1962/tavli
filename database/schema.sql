...
CREATE TABLE `trapezi` (
	...
	`telos`		TIMESTAMP NULL DEFAULT NULL COMMENT 'Τέλος παρτίδας',
...
CREATE TABLE `pexnidi` (
	...
	`xamenos`	TINYINT(1) NULL DEFAULT NULL COMMENT 'Ποιος έχασε το παιχνίδι',
	`ita`		ENUM (
		'ΜΟΝΟ',
		'ΔΙΠΛΟ',
		'ΠΑΡΤΙΔΑ'
	) NULL DEFAULT NULL COMMENT 'Μέγεθος ήττας',
