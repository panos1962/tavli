...
// Η function "readFileSync" διαβάζει ολόκληρο το περιεχόμενο ενός file και το
// επιστρέφει ως ενιαίο string. Όπως υπονοεί και το όνομά της η διαδικασία
// είναι σύγχρονη, επομένως μπλοκάρει τον skiser και γι' αυτό το λόγο θα πρέπει
// να χρησιμοποιείται μόνο κατά το ανέβασμα, ή το κατέβασμα του skiser.
